...
public class CesaroSnowFlakeTask extends FractalDrawingRenderTask {
	public static double MAX_LENGTH = 1950;
	...
	public CesaroSnowFlakeTask(JFXFractalExplorer fractalExplorer, FractalRenderTaskType taskType,Turtle turtle) {
	...
	private void _draw(boolean isAntiSnowFlake,boolean count) {
		...
		if(preference.getType() == KochSnowFlakeType.CESARO_ANTI_SNOWFLAKE) {
			length /= 2;
		}
		turtle.penUp();
		if(isAntiSnowFlake) {
